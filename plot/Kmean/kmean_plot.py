...
# loading data
mnist = np.load('kmean_mnist.npy')
svhn = np.load('kmean_svhn.npy')
cifar = np.load('kmean_cifar.npy')
cifar100 = np.load('kmean_cifar100.npy')
mini_imagenet = np.load('kmean_mini-imagenet.npy')
...
plt.savefig('./../../figure/kmean.pdf', bbox_inches="tight", pad_inches=0)
plt.show()
