...
train_loader, test_loader = mnist(root=root(), batch_size=64, num_workers=1)
...
network = Network()
network.to(device)
# network.load_state_dict(torch.load('./../weights/mnist-base.h5'))
...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs + 1):
        ...
        for data in train_loader:
            ...
            y_pred_batch, _ = network(x_true_batch)
    ...
    for test_data in test_loader:
        ...
        y_pred_batch, _ = network(x_test_batch)
    ...
    torch.save(network.state_dict(), './../weights/mnist-base.h5')
    print('All Done!')
