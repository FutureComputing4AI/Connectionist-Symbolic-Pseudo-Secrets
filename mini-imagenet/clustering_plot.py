...
cb = fig.colorbar(p1, ax=ax1, boundaries=np.arange(101) - 0.5, aspect=40, ticks=np.arange(100))
...
cb = fig.colorbar(p2, ax=ax2, boundaries=np.arange(101) - 0.5, aspect=40, ticks=np.arange(100))
cb.ax.set_yticklabels(labels)
...
cb = fig.colorbar(p3, ax=ax3, boundaries=np.arange(101) - 0.5, aspect=40, ticks=np.arange(100))
cb.ax.set_yticklabels(labels)
...
cb = fig.colorbar(p4, ax=ax4, boundaries=np.arange(101) - 0.5, aspect=40, ticks=np.arange(100))
cb.ax.set_yticklabels(labels)
...
cb = fig.colorbar(p5, ax=ax5, boundaries=np.arange(101) - 0.5, aspect=40, ticks=np.arange(100))
cb.ax.set_yticklabels(labels)
...
# plt.savefig('./../figure/clustering.png', bbox_inches="tight", pad_inches=0)
# plt.savefig('./../figure/clustering.pdf', bbox_inches="tight", pad_inches=0)
