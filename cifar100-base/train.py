...
train_loader, test_loader = cifar100_augmented(root=root(), batch_size=64, num_workers=1)
...
network = Network()
network.to(device)
# network.load_state_dict(torch.load('./../weights/cifar100-base.h5'))
...
if __name__ == '__main__':
    ...
    torch.save(network.state_dict(), './../weights/cifar100-base.h5')
    print('All Done!')
